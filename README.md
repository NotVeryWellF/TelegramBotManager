...
### Работающее API:
Поднял на AWS:
> http://ec2-3-142-70-53.us-east-2.compute.amazonaws.com/

При переходе на рут `/` будет простое сообщение с названием API, остальной функционал описан ниже
...
Также можно посмотреть документацию и потрогать функционал API ручками на поднятом хосте в разделе `/docs`:
> http://ec2-3-142-70-53.us-east-2.compute.amazonaws.com/docs
